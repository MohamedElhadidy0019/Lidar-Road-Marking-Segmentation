...
#     cloud = pcl.load("/home/mnabail/repos/Cylinder3D_spconv_v2/car_only_clustered/cloud_cluster_2.pcd")
#     # Centred the data
...
def main():
    ...
    cloud = pcl.load("/home/mnabail/repos/Cylinder3D_spconv_v2/car_only_clustered/cloud_cluster_1.pcd")
    print(cloud.size)
    dummy=0
    input(dummy)
